...
project = "tcpf"
copyright = "2020, the tcpf developers"  # noqa
...
latex_documents = [
    (master_doc, "tcpf.tex", "tcpf Documentation", "Denis Sergeev", "manual")
]
...
man_pages = [(master_doc, "tcpf", "tcpf Documentation", [author], 1)]
